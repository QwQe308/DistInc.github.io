...
var cnItems = {
    ...
    'Loading...': '读取中……',
    'Help': '帮助(Discord频道)',
    'Multiverse Map': '多宇宙地图',
    'Milestones': '里程碑',
    'Quilts': '多元织物',
    'Unlock': '解锁',
    'Enter the Multiverse': '进入多宇宙',
    'PRIME': '主宇宙',
    'Multiversal Quilt I': '多元织物 I',
    'Multiversal Quilt II': '多元织物 II',
    'Multiversal Quilt III': '多元织物 III',
    'Quilt Strength': '织物强度',
    ' % (based on Distance': ' %(基于距离',
    ' % (based on Knowledge': ' %(基于知识',
    ' % (based on Elementary Particles': ' %(基于基本粒子数量',
    'Main': '主界面',
    'Options': '选项',
    'Stats': '统计',
    'Achievements': '成就',
    ...
    'Absurd Dream': '荒诞之梦',
    'Absurd Extreme': '荒诞极限',
    'Absurd Extreme Dream': '荒诞极限之梦',
    'Absurd Hard': '荒诞困难',
    'Absurd Hard Dream': '荒诞困难之梦',
    'Selected': '已选择',
    'Activate': '可选择',
    'Balancing: balanced up to endgame': '平衡情况：已平衡至游戏终点。',
    'Balancing: balanced up to first multiverse': '平衡情况：已平衡至第一个多宇宙。',
    ...
    'Show/Hide Tabs': '显示/隐藏选项卡',
    'EXIT': '退出',
    'Mode Combination Table: ON': '模式组合表: 开启',
    'Mode Combination Table: OFF': '模式组合表: 关闭',
    ...
    'Your Motive is higher based on the Incline': '根据斜度数值，使动力变得更多',
    ...
    'Omnipotence VI': '全能 VI',
    'Omnipotence I-V': '全能 I-V',
    ' are stronger based on your Total Multiversal Energy': ' 的效果根据多元能量总数变得更好',
    'Anti-Incline': '反斜度',
    'The Incline\'s Secant is reduced by 25% for each unique Multiverse completed (50% stronger in non-Prime Multiverses': '每完成一个独特多宇宙，斜度的正割就减少25%(非主宇宙中效果减半',
    'Generator Evolution': '发生器进化',
    'The cost of Purchasing/Upgrading Generators scales slower based on your Energy, and the Energy effect is raised ^20.': '根据能量数值，使购买和升级发生器的花费提升速度减少。能量的效果变为原来的20次方。',
    'Anti-Incline II': '反斜度 II',
    'The Incline\'s Secant is divided based on your Ranks.': '将斜度的正割除以级别数值。',
    'Entropic Energy': '熵能',
    'Energy boosts Entropy gain.': '根据能量数值，增加熵的获取量。',
    'Thrusters V': '推进器 V',
    'Thrusters I-IV': '推进器 I-IV',
    'are exponentially stronger based on your Distance.': ' 的效果根据距离数值而指数提升。',
    'th root': '次方根',
    '% stronger': '%强化',
    '% slower': '%延迟',
    'Generator': '发生器',
    ...
    'Auto-Theoriverse': '自动学说宇宙',
    'Auto-Pion Field': '自动π介子场升级',
    'Auto-Spinor Field': '自动旋量场升级',
    'Auto-Multiverse Runs': '自动多宇宙重置',
    'Auto-Magma': '自动岩浆',
    'Auto-Plasma': '自动等离子体',
    'Mode': '模式',
    'AMOUNT': '数量',
    ...
    'Time Cube gain is increased by 33% for every OoM of Rockets (softcaps after a while).': '每有1数量级的火箭，时间方盒的获取量就增加33%(在较高数值时达到软上限)。',
    'Rocket Fuel is 10% stronger.': '火箭燃料的效果增加10%。',
    'Scrap & Intelligence gain are increased by 10% for every OoM of Time Cubes.': '每有1数量级的时间方盒，碎屑和智慧的获取量就增加10%。',
    'Time goes by 5% faster for every achievement gotten.': '每获得1个成就，时间就加快5%。',
    'Rankbot\'s interval boosts its magnitude.': '根据级别机器人的间隔数值，增加它的数量数值。',
    'Tierbot\'s interval boosts its magnitude, but not as strongly as the previous upgrade.': '根据阶层机器人的间隔数值，增加它的数量数值。效果比前一个升级弱。',
    'Rocket gain is increased by 10% for every OoM of Time Cubes (softcaps after a while).': '每有1数量级的时间方盒，火箭的获取量就增加10%(在较高数值时达到软上限)。',
    'Time Cubes and Dark Flow boost each other, and Scaled Rank scaling starts 10 Ranks later.': '时间方盒和黑暗流互相加强，折算的级别延迟10级别出现。',
    'Each component of The Dark Circle boosts Dark Flow, and Scaled Tier scaling starts 2 Tiers later.': '黑暗圆环的每个组成部分都可以增加黑暗流的数值，折算的阶层延迟2阶层出现。',
    'Each component of The Dark Circle boosts Pathogen Upgrade efficiency.': '黑暗圆环的每个组成部分都可以增加病原体升级的效果。',
    'Tiers do not reset anything, Scaled Tier scaling starts later based on your Dark Cores, and Tiers boost Cadaver gain.': '阶层不再重置任何东西。根据黑暗核心数值，使折算的阶层延迟出现。根据阶层数值，增加残骸的获取量。',
    'Scaled Rank scaling starts 32 Ranks later, and all effects of The Dark Circle are stronger based on your Dark Cores.': '折算的级别延迟32级别出现。根据黑暗核心数值，使黑暗圆环的所有效果变得更好。',
    'Time Cube gain & Coal gain boost each other.': '时间方盒的获取量和煤的获取量互相加强。',
    'Blue Flame is stronger based on your Time Cubes, and getting Rocket Fuel does not reset anything.': '根据时间方盒数值，使蓝色火焰的效果变得更好，获取火箭燃料不再重置任何东西。',
    ...
    'Double the Coal effect, and quintuple Pathogen gain.': '使煤的效果翻倍，且病原体的获取量变为原来的5倍。',
    'Dark Flow boosts Blue Flame.': '根据黑暗流数值，使蓝色火焰的效果变得更好。',
    'Coal boosts Pathogen Upgrade Power.': '根据煤数值，使病原体升级的效果变得更好。',
    'Coal boosts Rocket gain.': '根据煤数值，增加火箭的获取量。',
    'Dark Fluid & Rockets boost Rocket gain.': '根据黑暗流体和火箭数值，增加火箭的获取量。',
    'Time Speed is raised to a power based on your Pathogens.': '根据病原体数值，使时间速度变为某个数值为幂的指数。',
    'Unlock a fourth Furnace Upgrade, the Coal effect is 80% stronger, and Time Speed is nerfed less by Extreme Mode.': '解锁第4个熔炉升级，煤的效果增加80%，极限模式对时间速度的减成效果更缓和。',
    'The above upgrade uses a better formula.': '使上方升级的公式变得更好。',
    'The rocket effect also affects Coal gain.': '火箭的效果还可以影响煤的获取量。',
    'Time Speed is faster based on your Blue Flame.': '根据蓝色火焰数值，增加时间速度的数值。',
    'Furnace Upgrade 4 works in Furnace Challenges, but it is weaker in them.': '熔炉升级 4可以在熔炉挑战中生效，但效果减少。',
    //时间反演结束
    ...
    'Maximum Velocity is boosted by your Pathogens.': '根据病原体数值，增加最大速度的数值。',
    ...
    'Knowledge & Endorsements boost Dark Flow.': '根据知识和认可数值，增加黑暗流的数值。',
    ...
    'Unlock Accelerational Energy, which is created based on your Ranks & Tiers, and boosts your Velocital Energy, which in turn boosts your Time Speed.': '解锁加速能量，效果基于级别和阶层的数值，可以增加速度能量的效果，反过来也可以增加时间速度。',
    'Spectral Gems, Angels, & Demons boost Dark Flow.': '根据幽冥宝石，天使和恶魔数值，增加黑暗流的数值。',
    ...
    'Derivative Boosts boost Time Speed.': '导数提升还可以增加时间速度的数值。',
    ...
    'Accelerons': '加速子',
    'Inflatons': '暴胀子',
    'Trapped in the Theoriverse!': '强制进入学说宇宙！',
    'Exit The Theoriverse early for no reward.': '提前退出学说宇宙且不获得任何奖励。',
    ...
    'Complete Hadronic Challenge!': '完成强子挑战！',
    'Exit Hadronic Challenge early for no reward': '提前退出强子挑战且不获得任何奖励。',
    'Start Hadronic Challenge': '开始强子挑战',
    ...
    'Multiversal Selectors': '多宇宙选择器',
    'WARNING: STARTING A HADRONIC CHALLENGE WITH ANY OF THESE SELECTORS WILL FORCE A MULTIVERSE RESET!': '注意：选择以下任何选择器开始强子挑战都将强制进行一次多宇宙重置！',
    ...
    'Pions & Spinors make each other increase in cost 75% less (kept on Skyrmion reset': 'π介子和旋量使彼此的花费提升速度减少75%(斯格明子重置时保留',
    ...
    'The Perk Accelerator never goes Weakened or Broken, and the Hadron effect interval is smaller based on your Hadrons': '特权加速器不再有弱化效果和破碎效果，并且根据强子数值，减少强子获取学说点数的间隔',
    ...
    'Theory Tree Upgrade costs scale 50% slower, and the "Useless Theories" achievement\'s reward is raised to an exponent based on your Entropy.': '学说树升级的花费提升速度减少50%，根据熵数值，使”无用的学说“成就奖励变为某个数值为幂的指数。',
    'The Entropy effect is stronger based on your Best Entropy.': '根据最高熵数值，使熵的效果变得更好。',
    'Pion & Spinor gain are multiplied based on your Theory Points gotten from Hadrons.': '根据强子挑战获取的学说点数数值，使π介子和旋量的获取量乘以某个数值。',
    'Ω Particles multiply Skyrmion gain.': '使斯格明子的获取量乘以Ω 粒子数值。',
    'Entropy gain is increased by 50%.': '熵的获取量增加50%。',
    ...
    'The "Multiverse Conquered" achievement\'s final effect extends to 25,000 instead of 250, and the Cadaver effect is raised ^100.': '“征服多宇宙”成就的最后一个效果限制从250变为25000，并且残骸的效果变为原来的100次方。',
    ' Entropy': ' 熵',
    'Pions': 'π介子',
    'Spinors': '旋量',
    ...
    'Skyrmions boost Dark Flow.': '斯格明子还可以增加黑暗流的数值。',
    ...
    'The Entropy effect is raised to an exponent.': '熵的效果变为某个数值为幂的指数。',
